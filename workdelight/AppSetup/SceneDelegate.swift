...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    @objc func dismissSplashController(){
        ...
        if UserSession().isLogin() {
            ...
            let rootVC = K.StoryBoard.mainStoryBoard.instantiateViewController(withIdentifier: RecipeModel.identifier)
            self.window?.rootViewController = rootVC
            self.window?.makeKeyAndVisible()
            ...
            let rootVC = K.StoryBoard.mainStoryBoard.instantiateViewController(withIdentifier: LoginModel.identifier)
            self.window?.rootViewController = rootVC
            self.window?.makeKeyAndVisible()
